package com.noob.spider.scripts;
...
public class ScriptConsole {
    ...
    private static void startSpider(Params params) {
        ...
        if (params.getUrls() == null || params.getUrls().size() == 0) {
            ...
            System.out.println("Usage: java -jar com.noob.spider.webmagic.jar [-l language] -f script file [-t threadnum] [-s sleep time] url1 [url2 url3]");
            System.exit(-1);
        }
