...
import com.noob.spider.processor.SimplePageProcessor;
import com.noob.spider.scheduler.FileCacheQueueScheduler;
import org.junit.Ignore;
import org.junit.Test;
import com.noob.spider.samples.HuxiuProcessor;
...
//        Spider.me().pipeline(new FilePipeline()).scheduler(new FileCacheQueueScheduler(pageProcessor.getSite(),"/data/temp/com.noob.spider.webmagic/cache/")).
//                processor(pageProcessor).run();
        ...
        Spider.create(pageProcessor2).addUrl("http://www.diaoyuweng.com/home.php?mod=space&uid=88304&do=thread&view=me&type=thread&from=space").addPipeline(new FilePipeline()).scheduler(new FileCacheQueueScheduler("/data/temp/com.noob.spider.webmagic/cache/")).
                run();
