...
import com.noob.spider.selector.Json;
 ...
 * {@link #getResultItems()} get extract results to be used in {@link webmagic.pipeline.Pipeline}<br>
 * {@link #addTargetRequests(java.util.List)} {@link #addTargetRequest(String)} add urls to fetch                 <br>
 *
 * @author code4crafter@gmail.com <br>
 * @see webmagic.downloader.Downloader
 * @see webmagic.processor.PageProcessor
 * @since 0.1.0
 */
public class Page {
