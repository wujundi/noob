...
import com.noob.spider.model.annotation.Formatter;
import com.noob.spider.model.formatter.DateFormatter;
...
public class PageModelExtractorTest {
    ...
    public void testExtractJson() throws Exception {
        ...
        assertThat(modelDate.name).isEqualTo("com/noob/spider");
    }
