...
public class JsonPathSelectorTest {
    ...
    public void testJsonPath() {
        com.noob.spider.core.selector.JsonPathSelector jsonPathSelector = new com.noob.spider.core.selector.JsonPathSelector("$.store.book[*].author");
        ...
        jsonPathSelector = new com.noob.spider.core.selector.JsonPathSelector("$.store.book[?(@.category == 'reference')].title");
