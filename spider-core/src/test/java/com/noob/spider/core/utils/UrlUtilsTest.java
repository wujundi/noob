package com.noob.spider.core.utils;
...
public class UrlUtilsTest {
    ...
    public void testFixRelativeUrl() {
        String absoluteUrl = com.noob.spider.core.utils.UrlUtils.canonicalizeUrl("aa", "http://www.dianping.com/sh/ss/com");
        assertThat(absoluteUrl).isEqualTo("http://www.dianping.com/sh/ss/aa");

        absoluteUrl = com.noob.spider.core.utils.UrlUtils.canonicalizeUrl("../aa", "http://www.dianping.com/sh/ss/com");
        assertThat(absoluteUrl).isEqualTo("http://www.dianping.com/sh/aa");

        absoluteUrl = com.noob.spider.core.utils.UrlUtils.canonicalizeUrl("../mshz", "http://www.court.gov.cn/zgcpwsw/zgrmfy/");
    ...
    public void testGetDomain(){
        ...
        Assert.assertEquals("www.dianping.com", com.noob.spider.core.utils.UrlUtils.getDomain(url));
