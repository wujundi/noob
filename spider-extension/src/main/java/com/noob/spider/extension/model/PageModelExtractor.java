...
import com.noob.spider.core.selector.AndSelector;
import com.noob.spider.core.selector.OrSelector;
...
import com.noob.spider.extension.model.annotation.*;
import com.noob.spider.extension.model.formatter.ObjectFormatter;
import com.noob.spider.extension.model.formatter.ObjectFormatterBuilder;
import org.apache.commons.lang3.StringUtils;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import com.noob.spider.core.Page;
import com.noob.spider.extension.utils.ClassUtils;
import com.noob.spider.extension.utils.ExtractorUtils;
...
class PageModelExtractor {
    ...
    private com.noob.spider.core.selector.Selector targetUrlRegionSelector;

    private List<Pattern> helpUrlPatterns = new ArrayList<Pattern>();

    private com.noob.spider.core.selector.Selector helpUrlRegionSelector;
    ...
    private FieldExtractor getAnnotationExtractCombo(Class clazz, Field field) {
        ...
        if (comboExtract != null) {
            ...
            switch (comboExtract.op()) {
                case And:
                    selector = new com.noob.spider.core.selector.AndSelector(ExtractorUtils.getSelectors(extractBies));
                    break;
                case Or:
    ...
    private FieldExtractor getAnnotationExtractBy(Class clazz, Field field) {
        ...
        if (extractBy != null) {
            com.noob.spider.core.selector.Selector selector = ExtractorUtils.getSelector(extractBy);
    ...
    private void initClassExtractors() {
        ...
        if (annotation == null) {
            ...
            if (!targetUrl.sourceRegion().equals("")) {
                targetUrlRegionSelector = new com.noob.spider.core.selector.XpathSelector(targetUrl.sourceRegion());
            }
        }
        ...
        if (annotation != null) {
            ...
            if (!helpUrl.sourceRegion().equals("")) {
                helpUrlRegionSelector = new com.noob.spider.core.selector.XpathSelector(helpUrl.sourceRegion());
            }
        }
    ...
    com.noob.spider.core.selector.Selector getTargetUrlRegionSelector() {
